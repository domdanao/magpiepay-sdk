...
class PayoutDestination(BaseModel):
    ...
    bank_code: StrictStr = Field(description="Bank code for the beneficiary account.")
    account_number: StrictStr = Field(description="Beneficiary account number.")
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "bank_code", "account_number"]
