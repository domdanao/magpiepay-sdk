...
class QRPhCollectionResponse(BaseModel):
    """
    QRPhCollectionResponse
    """ # noqa: E501
    data: List[QRPhResponse]
    limit: StrictInt
    next_cursor: StrictStr
    __properties: ClassVar[List[str]] = ["data", "limit", "next_cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [QRPhResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "limit": obj.get("limit"),
