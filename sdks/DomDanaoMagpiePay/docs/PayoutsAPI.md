...
```swift
    open class func createPayoutV1PayoutsPost(payoutCreateRequest: PayoutCreateRequest, xAPIKey: String? = nil, authorization: String? = nil, completion: @escaping (_ data: PayoutSingleResponse?, _ error: Error?) -> Void)
```
...
// Create a payout
PayoutsAPI.createPayoutV1PayoutsPost(payoutCreateRequest: payoutCreateRequest, xAPIKey: xAPIKey, authorization: authorization) { (response, error) in
...
```swift
    open class func getPayoutV1PayoutsPayoutIdGet(payoutId: String, xAPIKey: String? = nil, authorization: String? = nil, completion: @escaping (_ data: PayoutSingleResponse?, _ error: Error?) -> Void)
```
...
// Get payout
PayoutsAPI.getPayoutV1PayoutsPayoutIdGet(payoutId: payoutId, xAPIKey: xAPIKey, authorization: authorization) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func listPayoutsV1PayoutsGet(limit: Int? = nil, cursor: String? = nil, referenceId: String? = nil, xAPIKey: String? = nil, authorization: String? = nil, completion: @escaping (_ data: PayoutCollectionResponse?, _ error: Error?) -> Void)
```
...
// List payouts
PayoutsAPI.listPayoutsV1PayoutsGet(limit: limit, cursor: cursor, referenceId: referenceId, xAPIKey: xAPIKey, authorization: authorization) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
