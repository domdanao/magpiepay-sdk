...
// APIClient manages communication with the Magpie API Documentation API v1.0.0
...
type APIClient struct {
	...
	QRPhRequestsAPI *QRPhRequestsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.QRPhRequestsAPI = (*QRPhRequestsAPIService)(&c.common)
